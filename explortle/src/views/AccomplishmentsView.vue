...
<template>
  <main class="bg-white text-gray-800 font-body">
      ...
      <div class="bg-gray-100 rounded-lg shadow-md p-8 flex flex-col justify-between relative ">
        <div>
          ...
          <p class="text-lg leading-relaxed">
            Since our founding, Explortle has connected students with career professionals through interactive workshops.
            Our hands-on experiences provide real-world exposure to STEM, finance, and other industries.
          </p>
          <p class="mt-4 text-lg leading-relaxed">
            Our initiative has already engaged over <span class="font-semibold text-blue-600">500 students</span> and
            featured <span class="font-semibold text-blue-600">six distinguished speakers</span> from various
    ...
    <section class="py-16 px-6">
      <h2 class="text-4xl font-heading font-bold text-purple-600 text-center fade-in">Our Accomplishments</h2>
